...
public class Enemy_3 : MonoBehaviour
{
    ...
    public Transform secondChildpoisiton;
    ...
    public void TakeDamage(int damage)
    {
        ...
        if (health <= 0)
        {
            health = 0;
            Destroy(gameObject);
            Instantiate(smallCubePrefab, secondChildpoisiton.position, Quaternion.identity);
            Instantiate(smallCubePrefab, transform.position, Quaternion.identity);
        }
